    ...
    public partial class insert_inventory : Form
    {
        ...
        private void add_button_product_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Name should be alphabets.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                if (Type.All(Char.IsLetter) == false)
                {
                    MessageBox.Show("Type should be alphabets.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                if (quantitys.All(Char.IsDigit) == false)
                {
                    MessageBox.Show("Quantitys should be integer.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                if (IsValidFloat(prices) == false)
                {
